...
If you use GitLab Community Edition, enable `SKIP_GITLAB_WEBHOOK_SETUP` because GitLab Community Edition does not support org-wide webhooks. Add this to `.env`:

```bash
SKIP_GITLAB_WEBHOOK_SETUP=true
```
